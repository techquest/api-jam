...
- Create a new Project App. (Please use REST/SOAP Client). See documentation [here] (https://www.interswitchgroup.com/paymentgateway)
...
- Register on the Payment Gateway portal. [sandbox] (https://sandbox.interswitchng.com/paymentgateway/). [Production] (https://www.interswitchgroup.com/paymentgateway). If you have an existing profile on Developer Console, use the same email address to register.
